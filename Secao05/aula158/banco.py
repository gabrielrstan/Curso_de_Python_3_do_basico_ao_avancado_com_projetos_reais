...
class Banco:
    ...
    def _checa_se_conta_e_cliente(self, cliente, conta):
    ...
    def autenticar(self, cliente: pessoas.Pessoa, conta: contas.Conta):
        return self._checa_agencia(conta) and \
            ...
            self._checa_se_conta_e_cliente(cliente, conta)
...
if __name__ == '__main__':
    c1 = pessoas.Cliente('Gabriel', 27)
    cc1 = contas.ContaCorrente(111, 222, limite=0)
    c1.conta = cc1
    c2 = pessoas.Cliente('João', 22)
