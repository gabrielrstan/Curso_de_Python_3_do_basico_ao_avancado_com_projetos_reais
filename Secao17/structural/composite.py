...
if __name__ == '__main__':
    ...
    camiseta2 = Product('camiseta2', 29.90)
    camiseta3 = Product('camiseta3', 19.90)
    ...
    smartphone2 = Product('smartphone2', 2000)
    smartphone3 = Product('smartphone3', 1000)
    ...
    caixa_smartphones.add(smartphone3)
