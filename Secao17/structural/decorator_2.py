...
class Hotdog:
    ...
    def price(self) -> float:
        return round(sum(
            [ingredient.price for ingredient in self._ingredients]), 2)
...
if __name__ == '__main__':
    ...
    cheese_egg_bacon_simple_hotdog = HotdogDecorator(
        egg_bacon_simple_hotdog, Cheese())
    print(cheese_egg_bacon_simple_hotdog)
